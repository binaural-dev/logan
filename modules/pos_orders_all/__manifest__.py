    ...
    'assets': {
        'point_of_sale.assets': [
            "pos_orders_all/static/src/css/pos.css",
				...
				# Misc
				"pos_orders_all/static/src/js/Misc/models.js",
				...
				"pos_orders_all/static/src/js/Popups/ReturnOrderPopup.js",
				"pos_orders_all/static/src/js/Popups/ReOrderPopup.js",
				"pos_orders_all/static/src/js/Popups/SODetail.js",
				"pos_orders_all/static/src/js/Popups/ImportSaleOrder.js",
				"pos_orders_all/static/src/js/Popups/PosBagPopup.js",
				
				# Coupon
				"pos_orders_all/static/src/js/Popups/GiftCoupon/AfterCreateCouponPopup.js",
				"pos_orders_all/static/src/js/Popups/GiftCoupon/CouponConfigPopup.js",
				"pos_orders_all/static/src/js/Popups/GiftCoupon/CreateCouponPopup.js",
				"pos_orders_all/static/src/js/Popups/GiftCoupon/SelectExistingCouponPopup.js",

				# Screens
				# Base
				"pos_orders_all/static/src/js/Screens/Base/ClientListScreen.js",
				"pos_orders_all/static/src/js/Screens/Base/OrderReceipt.js",
				"pos_orders_all/static/src/js/Screens/Base/OrderWidget.js",
				"pos_orders_all/static/src/js/Screens/Base/PaymentScreen.js",
				"pos_orders_all/static/src/js/Screens/Base/ProductScreen.js",
				"pos_orders_all/static/src/js/Screens/Base/ProductsWidget.js",
				"pos_orders_all/static/src/js/Screens/Base/ReceiptScreen.js",
				
				# Control Buttons
				"pos_orders_all/static/src/js/Screens/ControlButtons/ReturnOrderButton.js",
				"pos_orders_all/static/src/js/Screens/ControlButtons/SeePOSOrdersButton.js",
				"pos_orders_all/static/src/js/Screens/ControlButtons/OpenSOButton.js",
				"pos_orders_all/static/src/js/Screens/ControlButtons/PosBagButton.js",
				"pos_orders_all/static/src/js/Screens/ControlButtons/CreateSale.js",
				"pos_orders_all/static/src/js/Screens/ControlButtons/GiftCouponButton.js",

				# pos_orders functionality
				"pos_orders_all/static/src/js/Screens/pos_orders/OrderReprintReceipt.js",
				"pos_orders_all/static/src/js/Screens/pos_orders/OrderReprintScreen.js",
				"pos_orders_all/static/src/js/Screens/pos_orders/POSOrders.js",
				"pos_orders_all/static/src/js/Screens/pos_orders/POSOrdersScreen.js",
				
				# sales functionality
				"pos_orders_all/static/src/js/Screens/sales/SaleOrderScreen.js",
				"pos_orders_all/static/src/js/Screens/sales/SaleOrders.js",

				# Gift Coupon functionality
				"pos_orders_all/static/src/js/Screens/GiftCoupon/CouponPrint.js",
				"pos_orders_all/static/src/js/Screens/GiftCoupon/CouponReceiptScreen.js",
				"pos_orders_all/static/src/js/Screens/GiftCoupon/multiselect.js",
        ],
        'web.assets_qweb': [
            'pos_orders_all/static/src/xml/**/*',
        ],
    },
